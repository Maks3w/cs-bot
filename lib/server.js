...
WebServer.prototype._handleEvent = function (event) {
    if (event.type === 'PullRequestEvent') {
        this._handlePullRequestEvent(event.payload);
    }
    else {
        log.errorf('Invalid pull_request event: ${event}, ignoring...', {'event':event});
    }
};
